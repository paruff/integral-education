...
| Dimension | Value |
|---|---|
| **Where** (Quadrants) | I (individual interior perspective), We (shared values and community belonging), Its (social institutions and rule-based systems) |
...
**Growing Up path:** This module addresses the Amber stage of development on the Growing Up path. It orients learners to their current developmental location with honesty and dignity before any transition work begins.
...
This is not a way of seeing the world held at arm's length and evaluated — it is lived from the inside, the way a role is lived rather than studied. A person moving through an Amber-organized moment does not experience "believing in duty" — they experience duty simply being the shape of a good life. Naming this only becomes possible from outside it, which is exactly what the frameworks below attempt to do with care.
...
## How the Amber Stage Sees Reality
...
- Open with the gifts of Amber before naming limitations. Participants who are predominantly Amber will be more able to hear honest developmental analysis if they first feel seen and respected.
...
| **Non-judgmental stance** — You can think about others who are predominantly Amber without contempt or superiority | Find it difficult not to judge | Mostly non-judgmental but slipping occurs | Consistently curious and respectful toward Amber expression in others |
...
<RetrievalPrompt moduleName="Amber/Mythic Orientation" cards={[
  {q: "What are the defining characteristics of the Blue/Amber value system?", a: "Blue/Amber — characterized by absolutistic thinking, sacrifice for deferred reward, order and righteousness, and stability through clear rules."},
