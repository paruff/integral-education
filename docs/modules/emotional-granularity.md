...
Research by Lisa Feldman Barrett shows that people with higher emotional granularity:
- Experience emotions less intensely during stress
...
2. Recall a recent emotionally significant event
3. Resist the first label that comes to mind
4. Ask: *Is this exactly right? Or is there a more precise word?*
5. Use an emotion wheel or vocabulary list to explore alternatives
6. Write down 3–5 candidate emotions and select the most accurate

**Bonus:** Do this 3x daily as a spot-check practice.
...
- Were there emotions that felt hard to name? What category were they in?
- How does naming an emotion affect its intensity?
...
- In conflict, label your emotion internally before speaking
- Journal with at least 3 distinct emotion words per entry
