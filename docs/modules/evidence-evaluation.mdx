...
description: A mini-module on the epistemological shift from authority-based to evidence-based knowing — including the SIFT method, a source-quality rubric, and scenario-based practice in evaluating claims.

quadrants: ["I", "We", "It", "Its"]
level: "Amber → Rational"
lines: ["cognitive", "moral"]
states: ["reflective", "analytical"]
types: ["structured-first"]

tags: ["amber", "rational", "evidence", "scientific-literacy", "sift", "epistemology", "perry", "piaget", "caulfield", "belenky", "growing-up", "stage-development"]
---
...
3. **Find better coverage** — This kind of claim is the *source* others should be citing. What does it mean that it is the highest tier of evidence synthesis?
...
**Debrief:** This claim is structurally the most credible of the three. It names a specific evidence synthesis organization with a known methodology, reports an effect size with a defined metric, includes a sample of multiple independent trials, and uses calibrated language ("moderate-quality," not "proves"). Cochrane reviews are a gold standard of evidence synthesis. The appropriate response is not uncritical acceptance — Cochrane itself uses quality ratings to flag limitations — but this form of evidence warrants much higher confidence than Claims 1 or 2.
...
Q: What is the epistemological shift from Amber to Rational knowing?
A: From authority-based knowing ("Who said it?") to evidence-based knowing ("How well is this supported?"). The shift is additive — evidence evaluation is added to authority-trust, not substituted for it.

Q: What does SIFT stand for?
A: Stop (pause before reacting); Investigate the source (check who produced it before reading deeply); Find better coverage (seek independent corroboration); Trace claims (follow cited claims to their original source).

Q: Why is correlation not the same as causation?
A: Two variables can co-occur for many reasons other than one causing the other — including third-variable confounds and reverse causation. Establishing causation requires a study design that can isolate the variable of interest and rule out alternatives, such as a randomized controlled experiment.

Q: In the source quality rubric, what distinguishes peer-reviewed research from authoritative expert opinion?
A: Peer-reviewed research reports original studies with transparent methods, submitted to independent expert review before publication. Expert opinion synthesizes evidence through the judgment of qualified practitioners or institutions but does not necessarily present original data or transparent methods.

Q: What does a systematic review add beyond a single randomized controlled trial?
A: A systematic review aggregates findings from multiple independent studies using defined inclusion criteria, reducing the influence of any single study's limitations and providing a more reliable summary of the evidence base across diverse samples and contexts.

Q: What is Perry's concept of "Contextual Relativism" and why does it matter for evidence evaluation?
A: The recognition that views differ in quality — some are better supported than others — rather than all views being equally valid (Multiplicity) or truth being simply what authorities assert (Dualism). It is the epistemological position that makes evidence evaluation both possible and necessary.
