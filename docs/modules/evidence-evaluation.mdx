...
## Three Framework Lenses: Perry, Belenky, and Piaget

This module draws on three distinct developmental frameworks, each contributing a different layer to the picture of how evidence-based reasoning emerges. Perry's research maps the *sequence* — Dualism through Multiplicity to Contextual Relativism — showing that evidence evaluation is a developmental achievement, not simply information you either have or lack. Belenky's framework extends this sequence with attention to *how* knowing is constructed, distinguishing Received Knowing from Procedural Knowing as recognizable positions rather than a single universal ladder. Piaget's formal operational reasoning supplies the underlying cognitive *mechanism* — the capacity for hypothetical-deductive thought that makes systematic evidence evaluation possible in the first place.

These three lenses layer rather than compete: Piaget describes the cognitive hardware, while Perry and Belenky describe the developmental positions that hardware makes possible and the paths people actually take toward them. Used together, they explain both *that* people move from authority-based to evidence-based knowing and *how* that movement becomes cognitively available. Used substitutively — leaning on only one — risks either an overly mechanical account (Piaget alone) or an account with no cognitive grounding (Perry or Belenky alone).

## The Limitations of Evidence-Based Reasoning

Evidence evaluation, as a framework, has real boundaries worth stating plainly.

First, calibrated evidence evaluation takes time and cognitive effort that is not always available. Not every daily decision warrants a SIFT pass or a source-quality classification — treating every claim as worthy of full evaluation is neither realistic nor advisable. Part of the skill is knowing which claims are consequential enough to warrant the effort.

Second, evidence hierarchies (peer review > expert opinion > journalism > anecdote) are a strong general heuristic, not an infallible ranking. A well-designed observational study can outperform a poorly designed randomized trial; a single anecdote can sometimes be the first accurate signal of a pattern that formal research has not yet caught up to. The rubric orders *typical* reliability, not reliability that holds in every single instance.

Third, evidence evaluation cannot adjudicate questions of value — what *should* be done given the evidence is a separate question from what the evidence *shows*. Treating strong evidence as automatically settling a policy or personal decision skips the values step that evidence alone cannot perform.

---

## 🧭 Orient

You are about to apply SIFT and the Source Quality Rubric to three sample claims of increasing credibility, then to real sources in your own information environment. Before starting, notice your default response to a surprising claim: do you tend to accept, reject, or pause? There is no correct default — but knowing your own tendency lets you see, afterward, whether SIFT actually changed your process or just confirmed what you would have done anyway.

## 🌿 Encounter

Think of the last piece of information you shared — a link, a statistic, a headline — without checking its source first. Notice, honestly, what made it feel shareable in the moment: Did it confirm something you already believed? Did it come from someone you trust? Did you feel a flicker of surprise or outrage that made you want to pass it along quickly? That feeling is the exact moment SIFT is designed to interrupt, which is what Practice A below will walk through directly.
...
## Checkpoint: Genuine Calibration, Cynical Overcorrection, and Selective Skepticism

Having applied SIFT and the Source Quality Rubric across the practice claims, it is worth distinguishing three patterns that can each look like evidence-evaluation competency but are not equivalent.

**Genuine calibration** looks like: your confidence in a claim tracks the actual strength of the evidence behind it — you can hold a well-supported claim with high confidence and a poorly-supported one with low confidence, and you can name specifically *why* for each.

**Cynical overcorrection** is the failure mode where every claim, regardless of its actual evidentiary support, gets treated with the same blanket suspicion — "you can't trust any study" becomes a substitute for actually doing the evaluation. This looks rigorous but is really its own form of epistemic laziness: rejecting everything requires no more discrimination than accepting everything.

**Selective skepticism** is the more insidious pattern — applying SIFT rigorously to claims you are inclined to disbelieve, while giving claims that confirm your existing views a pass. The tools are used correctly, but only in one direction. This is often invisible from the inside because it feels like careful reasoning in every individual instance.

If you notice your SIFT process was more thorough for Claim 1 (which most people already doubt) than for a claim that matched something you wanted to be true, that is worth naming — it is the exact asymmetry evidence evaluation is meant to correct.
...
## The Gifts of Evidence Evaluation

Evidence evaluation offers a specific kind of freedom: the ability to update your beliefs in response to good evidence without that update feeling like a loss. When confidence is calibrated rather than fixed, new information becomes useful rather than threatening.

It also changes your relationship to uncertainty. Rather than needing every claim to be either fully trusted or fully dismissed, you gain a working vocabulary — Tier A, Tier B, Tier C; correlation versus causation; single study versus systematic review — for holding claims at exactly the confidence level they deserve. This tolerance for calibrated uncertainty is itself a mark of intellectual maturity.

Finally, evidence evaluation compounds across every domain that matters to you — health decisions, financial choices, civic participation, the information you pass on to people who trust you. The habit of asking "what actually supports this?" before accepting or sharing a claim is one of the more durable, transferable skills this platform can offer.
...
- Claims 1-3 in Practice A are ordered by ascending credibility on purpose — do not let participants skip ahead, since the contrast between claims is part of the calibration training.
- Watch for the Stabilize checkpoint's "selective skepticism" pattern showing up live — a participant applying SIFT rigorously to a claim they doubt and waving through a claim that confirms their existing views.
- The Source Quality Rubric works best as a group exercise using Question 3's ranking scenario before individuals apply it to their own information diet.
- If a participant treats the rubric as a reason to distrust all non-peer-reviewed sources categorically, revisit the "Gifts" framing — calibration, not blanket rejection, is the goal.
