...
Q: What is the gross state in Wilber's AQAL framework?
A: The ordinary waking state of sensorimotor and physical experience — the baseline for all other state work.

Q: What is the difference between a state and a stage in AQAL?
A: States are temporary experiences (waking, dreaming, deep sleep, witnessing, non-dual). Stages are permanent developmental acquisitions of perspective-taking capacity.

Q: Why is gross state awareness necessary before subtle or causal state training?
A: Without a stable physical baseline, learners cannot detect when they have left gross-state reality, leading to confusion between emotional flooding and genuine subtle-state access.

Q: What does "embodied presence" mean in somatic psychology?
A: Full, non-dissociated inhabitation of the body — attending to physical sensations as they are, without bypassing them through thought or reactive behaviour.

Q: Name the five AQAL states in order.
A: Gross (waking), Subtle (dreaming), Causal (deep sleep), Witnessing (turiya), Non-dual.
...
For the full safety framework, see the [Shadowwork Safety Standard](../safety/shadowwork-safety-standard). If distress is unexpectedly activated, follow the [Trauma Activation Response Protocol](../safety/shadowwork-safety-standard#trauma-activation-response-protocol).
