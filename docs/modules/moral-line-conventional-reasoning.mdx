...
sidebar_label: Preconventional & Conventional Moral Reasoning
...
This module uses a modified loop: **Orient → Encounter → Learn → Practice → Stabilize → Integrate → Reflect → Assess**. Encounter comes early so you map your real moral reasoning before trying to improve it.
