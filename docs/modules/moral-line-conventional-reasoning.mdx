...
description: A practical module for distinguishing preconventional and conventional moral reasoning from the inside, with
  emphasis on Stage 3/4 justice tensions and Gilligan care Position 2 at the conventional level.
quadrants:
- I
- We
- It
...
## Three Framework Lenses on Conventional Moral Reasoning

This module draws on three complementary frameworks. Kohlberg's justice-track stage sequence supplies the structural map for Stage 3 and Stage 4 as qualitatively distinct moral organizations, each with a genuine developmental achievement and a characteristic limitation rather than one simply being "more moral" than the other. Gilligan's care-track sequence supplies a parallel structural map on a different axis, showing that Position 2's self-sacrificing care is a real conventional achievement — others are genuinely included in the moral field — even though it produces its own characteristic cost. Kegan's constructive-developmental lens on institutional adult life supplies the practical grounding for why this range matters so much: most adult institutional functioning, even among highly educated adults, runs on Stage 3-4 structure, so accurate recognition here has more everyday consequence than recognition of any single postconventional insight. Held together, these three lenses let conventional reasoning be mapped precisely on two tracks, evaluated for its genuine strengths rather than dismissed as "merely conventional," and recognized as the operating structure of most institutional life rather than a stage to be hurried past.
...
## The Limitations of a Conventional-Only Lens

Kohlberg's and Gilligan's stage maps are diagnostic tools, not a complete moral theory, and treating them as one risks two distinct errors. The first is mistaking accurate stage recognition for moral guidance: knowing that a decision is "Stage 4 procedural reasoning" tells you what structure is organizing the judgment, not whether the judgment is right in this specific case — a leader can correctly identify their own Stage 4 reasoning and still owe the situation a postconventional exception. The second is treating the stage sequence as a ranking that settles arguments: naming someone else's response as "Stage 3" or "Stage 4" can become a rhetorical move that dismisses a real moral concern rather than engaging it, especially when the labeler's own reasoning is no more developed on the dimension actually in dispute. A third, quieter limitation is scope: this module's map addresses individual moral cognition, not the structural and systemic conditions — incentives, power, scarcity — that often determine which stage of reasoning is even survivable to act on in a given institutional context.
...
## The Gifts of Conventional Stage Recognition

Learning to distinguish Stage 3 from Stage 4 in your own moral language delivers a gift that lasts well beyond this module: the ability to know, in the moment of a real decision, which loyalty you are actually honoring — a relationship or a rule — instead of experiencing the tension as a single undifferentiated pull. The Stage 3-4 Tension Mapping practice offers a second gift: a concrete method for holding two valid but competing conventional claims side by side without collapsing prematurely into either one, which is itself a form of moral maturity most people never explicitly practice. And naming Care Position 2's self-sacrifice pattern gives a third, more personal gift — the capacity to recognize the early signs of relational resentment while there is still time to renegotiate the balance of care, rather than only after it has curdled.
...
- Open by naming that conventional reasoning is not "low" reasoning — per the Orient Admonition, Stage 3 and Stage 4 are the moral architecture of most adult institutional life, and framing them otherwise invites defensiveness rather than accurate self-recognition.
- When facilitating Encounter (b) as a group exercise, hold both the Stage 3 and Stage 4 lens as genuinely valid rather than steering participants toward a "correct" resolution — the practice is mapping the tension, not resolving it.
- Watch for the dismissal pattern named in Limitations: a participant using postconventional-sounding language to dismiss another's Stage 3/4 response rather than engaging its real content. Redirect toward the Distinction B diagnostic question in Stabilize.
- If Encounter (a)'s review of past moral decisions surfaces active distress rather than reflective recognition, follow the Contraindications in the Safety Note and move to Orient + Learn only.
