...
description: A practical module for developing postconventional moral reasoning capacity — Stage 5 social-contract thinking,
  Stage 6 universal ethical principles, and Care Position 3 integrated care — through moral dilemma practice, civil disobedience
  case study, and a rigorous pre/trans checkpoint.
quadrants:
- I
- We
- It
...
## Three Framework Lenses on Postconventional Reasoning

This module draws on three complementary frameworks. Kohlberg's justice-track sequence supplies the structural map for Stage 5 social-contract reasoning and Stage 6 universal-principle reasoning as distinct capacities, each with its own characteristic achievement and question. Gilligan's care-track sequence supplies a parallel structural map in Care Position 3, showing that integrated care — honoring self and other with equal moral weight — is a postconventional achievement on its own axis, not simply an extension of justice reasoning. Kohlberg and Turiel's moral dilemma methodology supplies the practice mechanism that makes the other two frameworks more than descriptive: engaging dilemmas that cannot be resolved from your current stage produces the productive disequilibrium that catalyzes development, rather than leaving postconventional reasoning as an intellectual position adopted without lived effort. Held together, these three lenses let postconventional capacity be mapped precisely on two tracks, distinguished from performative appropriation of Stage 6 language, and developed through genuine practice rather than assumed from exposure to the concepts alone.
...
## The Limitations of the Postconventional Framework

This module's dilemma methodology and pre/trans checkpoint are diagnostic tools for a single dimension — moral reasoning structure — and are easy to overextend past that dimension. The first limitation is the gap this module itself names between moral knowledge and moral courage: correctly articulating Stage 6 reasoning about a dilemma is not the same capacity as acting on it at real cost, and the checkpoint can confirm sophisticated reasoning while leaving the action gap completely untouched. The second is that Stage 5-6 language is unusually easy to borrow rhetorically — invoking "universal principle" or "integrated care" carries social prestige in many educated contexts, which means the presence of postconventional vocabulary is weak evidence of postconventional structure and the Distinction A/B checkpoints have to be applied rigorously rather than taken as confirmed once articulated. A third, structural limitation: this module evaluates individual moral cognition in isolated dilemmas, not the real-world consequences of acting on a Stage 6 conviction inside a specific institution, family, or legal system — knowing a principled action is required does not by itself supply the practical wisdom to execute it well or safely.
...
## The Gifts of Postconventional Practice

Working through dilemmas that exceed your current stage's resolving power delivers a gift beyond any single answer: the felt experience of your own reasoning's ceiling, which is a more durable teacher than any description of Stage 5 or Stage 6 could be on its own. The Civil Disobedience Case Study offers a second gift — a concrete historical anchor for what principled moral courage actually costs, which keeps Stage 6 from staying an abstract or self-flattering idea. And the Care Position 3 practice gives a third, quietly significant gift: permission to treat your own needs as morally real in a relationship, converting self-care from an act you have to justify against guilt into a recognized component of genuine care for the other person.
...
- Confirm participants have completed [Moral Line — Preconventional & Conventional Reasoning](./moral-line-conventional-reasoning) before this module — the dilemma methodology assumes fluency locating Stage 3/4 reasoning first.
- When facilitating Encounter (a) or (b) as a group, resist supplying the "correct" resolution to any dilemma — per Orient, the goal is locating where each participant's own reasoning reaches its ceiling, not converging on a shared answer.
- Watch for Stage 6 language deployed for social positioning within the group itself (Distinction B) — a participant's moral stance shifting to match the room is itself the phenomenon the Stabilize section asks learners to detect in themselves.
- If Encounter (c)'s mapping of a real relationship surfaces active guilt, grief, or relational conflict beyond reflective discomfort, follow the Contraindications in the Safety Note and pause that dilemma.
