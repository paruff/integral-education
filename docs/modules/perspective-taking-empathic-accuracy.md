---
id: perspective-taking-empathic-accuracy
title: "EI-09 · Perspective-Taking & Empathic Accuracy"
sidebar_label: EI-09 · Perspective-Taking & Empathic Accuracy
description: An Interpersonal Line module distinguishing affective empathy, cognitive empathy, and compassionate empathy; grounding empathic accuracy in Zaki's trainability research and Epley's egocentrism findings; and mapping AQAL 1st/2nd/3rd-person perspectives as the developmental sequence of perspective-taking capacity.

quadrants: ["We", "I", "It"]
level: "Interpersonal Line — Institutional altitude and above (Kegan 4+)"
lines: ["interpersonal", "emotional", "cognitive"]
states: ["reflective"]
types: ["self-paced", "journaling-based", "partner-supported"]
...
This is the bridge between the stage-development concern of the [Perspective-Taking Capacity module](./perspective-taking-capacity) and the line-development concern of this module: ToM provides the cognitive infrastructure; empathic accuracy training develops the precision with which that infrastructure is used.
...
1. **Which of the three types of empathy do you rely on most habitually?** What are the interpersonal gifts and costs of that preference?

2. **Where in your relational life do you currently have the highest empathic accuracy?** What conditions produce that accuracy — and can any of those conditions be extended to other relationships?

3. **What is your characteristic inference error** — do you tend to project your own experience onto others (false consensus), to overestimate others' emotional intensity, to underestimate it, or to construct a version of the other that fits a familiar relational script?

4. **Where in your current relationships would accurate perspective-verification most improve the quality of contact?**
