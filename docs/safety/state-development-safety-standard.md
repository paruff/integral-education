---
id: state-development-safety-standard
title: State Development Safety & Integration Standards
sidebar_label: State Development Safety
...
1. **Persistent depersonalization** — a sustained sense of being disconnected from one's body, thoughts, or identity that does not resolve within 24 hours after practice ends.
2. **Derealization** — ongoing experience of surroundings appearing unreal, dreamlike, or distorted beyond what is described as normal transient meditation phenomena.
3. **Uncontrolled oscillation between states** — involuntary and distressing cycling through altered-state experiences outside of practice sessions.
4. **Existential terror or nihilistic crisis** — acute and overwhelming loss of meaning, value, or sense of personal existence that persists beyond the session.
5. **Functional impairment** — inability to carry out ordinary daily responsibilities (work, relationships, self-care) attributable to state practice.
6. **Re-emergence of suppressed trauma material** — sudden intrusive memories, flashbacks, or intense body-level activation not previously present, arising in context of state practice.
7. **Auditory or visual phenomena outside practice sessions** — perception of sounds, lights, or presences that are not present and that cause distress or confusion about reality.
8. **Social withdrawal and isolation** — marked and rapid reduction in engagement with others attributed to state experiences, particularly if accompanied by grandiosity or messianic beliefs.
